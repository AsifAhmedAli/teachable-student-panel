...
function fetchStudentData(studentId, storedToken) {
...
// console.log(courseId);
    $.ajax({
        url: `${baseUrl}/api/students/get-single-course/${courseId}/${studentId}`,
        type: 'GET',
        headers: {
            ...
            videos.forEach(video => {
                ...
                <div class="jsx-2138578525 bar"><svg class="jsx-2138578525 status-icon">
                                ...
                                <div class="jsx-2138578525 info-wrapper">
                                    <div class="jsx-2138578525 info"><svg class="jsx-2138578525 icon">
